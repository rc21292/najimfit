			...
			$dites = [
				...
				[
					...
					[
						...
						'foodcalary' => $table->breakfast_calories,
						'foods' => 
						[
							0 => 
							[
								'food1' => 
								[
									'foodName' => $table->breakfast_name,
									'foodCallery' => $table->breakfast_calories,
								],
								'food2' => 
								[
									'foodName' => 'Lebna (3 spoons) + Olive Oil (1 spoon)',
									'foodCallery' => '23',
								],
							],
						],
					...
					[
						'foodCategory' => 'lunch',
						'foodcalary' => $table->lunch_calories,
						'foods' => 
						[
							0 => 
							[
								'food1' => 
								[
									'foodName' => $table->lunch_name,
									'foodCallery' => $table->lunch_calories,
								],
								'food2' => 
								[
									'foodName' => 'Lebna (3 spoons) + Olive Oil (1 spoon)',
					...
					[
						'foodCategory' => 'dinner',
						'foodcalary' => $table->dinner_calories,
						'foods' => 
						[
							0 => 
							[
								'food1' => 
								[
									'foodName' => $table->dinner_name,
									'foodCallery' => $table->dinner_calories,
								],
								'food2' => 
								[
									'foodName' => 'Lebna (3 spoons) + Olive Oil (1 spoon)',
					...
					[
						'foodCategory' => 'snacks',
						'foodcalary' => $table->snacks1_calories+$table->snacks2_calories+$table->snacks3_calories,
						'foods' => 
						[
							0 => 
							[
								'food1' => 
								[
									'foodName' => $table->snacks1_name,
									'foodCallery' => $table->snacks1_calories,
								],
								'food2' => 
								[
									'foodName' => 'Lebna (3 spoons) + Olive Oil (1 spoon)',
							...
							[
								'food1' => 
								[
									'foodName' => $table->snacks2_name,
									'foodCallery' => $table->snacks2_calories,
								],
								'food2' => 
								[
									'foodName' => 'Lebna (3 spoons) + Olive Oil (1 spoon)',
							...
							[
								'food1' => 
								[
									'foodName' => $table->snacks3_name,
									'foodCallery' => $table->snacks3_calories,
								],
								'food2' => 
								[
									'foodName' => 'Lebna (3 spoons) + Olive Oil (1 spoon)',
