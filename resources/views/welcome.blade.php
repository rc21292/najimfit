    ...
    <div class="carousel-item @if ($i == 0 ) active @endif">
      <div class="carousel-caption">
        ...
        <div class="form-group btn-inline">
          <button type="button" onclick="location.href='{{url('/contactus')}}';" class="btn btn-primary">انضم إلينا</button>
  ...
  <ol class="carousel-indicators list-inline">
    ...
    <li class="list-inline-item active">
      <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#custCarousel">
        <img src="{{asset('uploads/slider/'.$slider->image)}}" class="img-fluid">
      </a>
    </li>
    @else
      ...
      <div class="col-sm-12 col-xs-12 padding">
        <div class="grid">
          ...
          <figure class="effect-ming">
            <img style="width: 600px !important; height: 300px !important;" src="{{asset('uploads/packages/dashboard/'.$package->image_full)}}" alt="img01" class="img-fluid">
