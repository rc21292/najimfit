				...
				<div class="row">
					<div class="col-md-12">
						<div class="ms-panel">
							...
							<div class="ms-panel-body">
								<form id="form-id" action="{{route('unblock-user-from-app')}}" method="post">
									{{csrf_field()}}
									<div class="modal-body">
										<div class="ms-form-group has-icon">
											<label><b>Select Client To Unblock from App</b></label><br>
									...
									<div class="modal-footer">
										<a href='javascript:' onclick='submitform();' class="btn btn-primary">Block Client</a>
									</div>
								</form>
							</div>
						</div>
...
<script type="text/javascript">
	function submitform(){
		...
		swal({
			title: "Are you sure?",
			text: "to Block this client from App!",
			icon: "warning",
			buttons: true,
			dangerMode: true,
		})
