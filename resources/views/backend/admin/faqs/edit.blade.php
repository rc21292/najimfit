				...
				<form class="needs-validation clearfix" method="POST" action="{{route('faqs.update',$faqs->id)}}" novalidate>
					...
					<div class="form-row">
						...
						<div class="col-xl-12 col-md-12 mb-3">
							...
							<div class="input-group">
								<input type="text" id="question_arabic" name="question_arabic" class="form-control" placeholder="Question(in Arabic)" value="{{$faqs->question_arabic}}">
								<div class="invalid-feedback">
						...
						<div class="col-xl-12 col-md-12 mb-3">
							...
							<div class="input-group">
								<textarea rows="5" id="answer_arabic" name="answer_arabic" class="form-control" placeholder="Answer(in Arabic)">{{$faqs->answer_arabic}}</textarea>
								<div class="invalid-feedback">
