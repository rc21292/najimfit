    ...
    <div class="ms-panel ms-panel-fh" style="width: 100%">
        ...
        <div class="tab-content">
            ...
            <div class="ms-panel-body">                
                <form class="needs-validation clearfix" method="POST" action="{{route('slider.update',$slider->id)}}" enctype="multipart/form-data">
                    @csrf
                        {{ method_field('PUT') }}
                    <div class="form-row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="title" name="title" value="{{ $slider->title }}" class="form-control" placeholder="Title" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" dir="rtl" id="title" name="title_arabic" value="{{ $slider->title_arabic }}" dir="rtl" class="form-control" placeholder="اسم الحزمة">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <textarea rows="8" id="description" name="description" class="form-control" placeholder="Description" required>{{ $slider->description }}</textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <textarea rows="8" id="description" dir="rtl" name="description_arabic" class="form-control" placeholder="أدخل الوصف">{{ $slider->description_arabic }}</textarea>
                                <div class="invalid-feedback">
                                    Please Write Description.
                                </div>
                            </div>
...
<!-- purify.min.js is only needed if you wish to purify HTML content in your preview for 
    ...
    <script>
            ...
            initialPreview: [
            "{{asset('uploads/slider/'.$slider->image)}}"
            ],
             initialPreviewAsData: true, // defaults markup

    initialPreviewFileType: 'image', // image is the default and can be overridden in config below
    initialPreviewConfig: [
    {caption: "{{$slider->image}}", url: "{{route('slider-image-delete',$slider->id)}}", key: {{$slider->id}} }
    ],
    @endif
});
    </script>
