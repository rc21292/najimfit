                                        ...
                                        <form id="chat-form">
                                            <ul class="ms-list-flex mb-0">
                                                ...
                                                <li>
                                                    ...
                                                    <li><div class="addFiles"><input id="file" type="file" name="file"></div></li>
...
<script>
    ...
    var firebaseConfig = {
        ...
        var id3 = "{{ $receptorUser->id }}_{{ Auth::user()->id }}";
            ...
            if(snapshot.val() != null) {
                snapshot.forEach(function(childSnapshot) {
                    ...
                    if (sender_reseptent.trim() == id3.trim()) {
                        ...
                        let current_datetime = new Date(childData.created_at);
