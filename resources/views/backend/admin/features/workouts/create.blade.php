	...
	<div class="col-xl-8 col-md-12">
		<div class="ms-panel ms-panel-fh">
			...
			<div class="ms-panel-body">
				<form class="needs-validation clearfix" method="POST" action="{{route('exercise.store')}}" novalidate enctype="multipart/form-data">
					@csrf
					<div class="form-row">
						<div class="col-md-12">
							<label for="name">Exercise Name</label>
							<div class="input-group">
								<input type="text" id="name" name="name" class="form-control" placeholder="Exercise Name" required>
						...
						<div class="col-xl-6 col-md-12">
							...
							<div class="input-group">
								<input type="number" class="form-control" name="sort" id="sort" placeholder="Sort Order" value="{{$sort}}" required>
								<div class="invalid-feedback">
						...
						<div class="col-xl-6 col-md-12">
							...
							<div class="input-group">
								<input type="number" class="form-control" name="time" id="time" placeholder="Exercise Time" required>
								<div class="invalid-feedback">
									Please provide Time.
								</div>
							</div>
						...
						<div class="col-xl-6 col-md-12">
							...
							<div class="input-group">
								<input type="text" class="form-control" name="calories" id="calories" placeholder="Calories Range (in Kcal)" required>
								<div class="invalid-feedback">
									Enter Calorie Range.
								</div>
							</div>
						...
						<div class="col-md-12">
							...
							<div class="input-group">
								<textarea rows="8" id="description" name="description" class="form-control" placeholder="Write about Exercise." required></textarea>
								<div class="invalid-feedback">
						...
						<div class="col-md-12">
							...
							<div class="input-group">
								<input type="text" class="form-control" name="video" id="video" placeholder="Youtube Link">
								<div class="invalid-feedback">
