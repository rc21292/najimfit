			...
			<div class="col-sm-8">
				<nav aria-label="breadcrumb " class="ms-panel-custom">
					<ol class="breadcrumb pl-0">
						...
						<li class="breadcrumb-item active" aria-current="page">Workout Information List</li>
					</ol>
				</nav>
			</div>
	...
	<div class="col-md-12">
		<div class="ms-panel">
			<div class="ms-panel-header">
				<h6>Workout Information List</h6>
			</div>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title has-icon ms-icon-round "><i class="flaticon-share bg-primary text-white"></i> Add Information Category</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			</div>
			<form action="{{route('workout-information')}}" method="post">
				{{csrf_field()}}
				<div class="modal-body">
					<div class="ms-form-group has-icon">
						<label>Information Name</label>
						<input type="text" placeholder="Information Name" class="form-control" name="name" value="">
					</div>
					<div class="ms-form-group has-icon">
					...
					<div class="ms-form-group has-icon">
						...
						<textarea placeholder="Write Information" class="form-control" name="description" value=""></textarea>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title has-icon ms-icon-round "><i class="flaticon-share bg-primary text-white"></i> Edit Workout Information</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			</div>
			<form action="{{route('workout-information-update')}}" method="post">
				{{csrf_field()}}
				{{method_field('patch')}}
				<div class="modal-body">
					...
					<div class="ms-form-group has-icon">
						<label>Information Name</label>
						<input type="text" placeholder="Information Name" id="name" class="form-control" name="name" value="">
					...
					<div class="ms-form-group has-icon">
						<label>Information Description</label>
						<textarea placeholder="Write Information" id="description" class="form-control" name="description" value=""></textarea>
...
<script>
	...
	[ "{{ $no++ }}" ,"{{ $category->name }}","<a data-name='{{$category->name}}' data-name_arabic='{{$category->name_arabic}}' data-description='{{$category->information}}' data-description_arabic='{{$category->information_arabic}}' data-catid='{{$category->id}}' data-toggle='modal' data-target='#edit'><i class='fas fa-pencil-alt ms-text-primary'></i></a>"],
	@endforeach
	];
