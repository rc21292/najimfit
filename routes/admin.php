...
// Coupons Route
	...
	Route::get('getChatsPerDay', 'PerformanceController@getChatsPerDay');
	Route::get('getTablesPerDay', 'PerformanceController@getTablesPerDay');
	Route::get('getComplaintsPerDay', 'PerformanceController@getComplaintsPerDay');
